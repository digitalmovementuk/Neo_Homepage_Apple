        ...
        <div className="container-v3 pb-6 sm:pb-10 md:pb-20 lg:pb-24">
          <div className="flex flex-col items-center text-center gap-5 md:flex-row md:items-end md:justify-between md:text-left md:gap-10">
            ...
            <div className="flex flex-col items-center md:items-start w-full md:w-auto">
              ...
              {/* Mobile-only CTA — single Buy-style pill below H2 */}
              <motion.a
                initial={{ opacity: 0, y: 12 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.85 }}
                href="#contact"
                className="md:hidden mt-6 inline-flex items-center justify-center rounded-full bg-[#0071E3] hover:bg-[#0077ED] text-white font-medium text-[14px] px-6 py-2.5 transition-colors"
              >
                {t.hero.cta}
              </motion.a>
            </div>
